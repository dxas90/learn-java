# learn [![Build Status](http://192.168.100.6:5000/api/badges/dxas90/learn-java/status.svg)](http://192.168.100.6:5000/dxas90/learn-java)
this is to learn openshift :)

```sh
oc new-app https://github.com/dxas90/learn-java.git
```
